...
/**
 * @title   MPT Staking Pools Contract
 * @author  MY Pocket Token Foundation
 * @notice  This contract is used for staking MPT-V3 (ERC20) tokens to support a validator running in the Ethereum blockchain network and distribute rewards.
 **/
contract MPTPools {
    ...
    constructor(IERC20 _MPTV3) public {
        owner = msg.sender;
        MPTV3 = _MPTV3;
    }
    ...
    function createNewStake(uint256 _amount, uint8 _lockupPeriod, bool _compound) public {
        ...
        require(IERC20(MPTV3).transferFrom(msg.sender, address(this), _amount), "Couldn't take the NET from the sender");
    ...
    function withdrawRewards(uint256 _index) public {
        ...
        require(MPTV3.transfer(msg.sender, total));
    ...
    function _accredit(address _staker, uint256 _index, uint256 _total) public onlyOwner {
        ...
        require(IERC20(MPTV3).transferFrom(msg.sender, address(this), _total), "Couldn't take the NET from the sender");
    ...
    function _accreditMultiple(address _staker, uint256[] memory _totals) public onlyOwner {
        ...
        require(IERC20(MPTV3).transferFrom(msg.sender, address(this), total), "Couldn't take the NET from the sender");
    ...
    function _closeStake(address _staker, uint256 _index) internal returns (uint256) {
        ...
        require(MPTV3.transfer(_staker, total));
